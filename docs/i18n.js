...
(function () {
  const DICT = {
    'zh-CN': {
      ...
      footer: '{brand} · <a href="https://github.com/zlimao/rixing" target="_blank" rel="noopener">GitHub</a> · MIT © 李貌',
    },
    en: {
      lang_name: 'English',
  ...
  const DOWNLOAD = {
    'zh-CN': 'https://github.com/zlimao/rixing/releases/latest',
    intl: 'https://github.com/zlimao/rixing/releases/latest',
  };
