...
(function () {
  const DICT = {
    'zh-CN': {
      ...
      hero_meta: 'macOS 11+ · Apple Silicon · 安装包仅 ~4 MB · MIT 开源',
    ...
    en: {
      ...
      hero_meta: 'macOS 11+ · Apple Silicon · ~4 MB installer · MIT licensed',
    ...
    ja: {
      ...
      hero_meta: 'macOS 11+ · Apple Silicon · インストーラー約 4 MB · MIT ライセンス',
    ...
    ko: {
      ...
      hero_meta: 'macOS 11+ · Apple Silicon · 설치 파일 약 4 MB · MIT 라이선스',
    ...
    es: {
      ...
      hero_meta: 'macOS 11+ · Apple Silicon · instalador de ~4 MB · licencia MIT',
    ...
    fr: {
      ...
      hero_meta: 'macOS 11+ · Apple Silicon · installateur ~4 Mo · licence MIT',
    ...
    de: {
      ...
      hero_meta: 'macOS 11+ · Apple Silicon · ~4 MB Installer · MIT-Lizenz',
    ...
    ru: {
      ...
      hero_meta: 'macOS 11+ · Apple Silicon · установщик ~4 МБ · лицензия MIT',
