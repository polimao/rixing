...
(function () {
  ...
  const WELCOME = {
    'zh-CN': { settings_title: '日行设置', welcome_title: '欢迎使用日行', welcome_where: '日行住在屏幕右上角的菜单栏里', welcome_left_t: '左键点击', welcome_left_d: '打开或收起窗口', welcome_right_t: '右键点击', welcome_right_d: '念日 · 窗口分屏 · 通用设置 · 关于', welcome_two_t: '菜单栏新增两个图标', welcome_two_d: '待办清单 与 日历', welcome_start: '开始使用' },
    en: { settings_title: 'RiXing Settings', welcome_title: 'Welcome to RiXing', welcome_where: 'RiXing lives in the menu bar, top-right of your screen', welcome_left_t: 'Left-click', welcome_left_d: 'Open or hide the window', welcome_right_t: 'Right-click', welcome_right_d: 'Anniversaries · Split screen · General · About', welcome_two_t: 'Two new menu bar icons', welcome_two_d: 'To-do list and Calendar', welcome_start: 'Get started' },
    ja: { settings_title: '日行の設定', welcome_title: '日行へようこそ', welcome_where: '日行は画面右上のメニューバーにいます', welcome_left_t: '左クリック', welcome_left_d: 'ウィンドウを開く/閉じる', welcome_right_t: '右クリック', welcome_right_d: '記念日 · 画面分割 · 一般設定 · このアプリについて', welcome_two_t: 'メニューバーに2つのアイコンを追加', welcome_two_d: 'やること と カレンダー', welcome_start: '使ってみる' },
    ko: { settings_title: '일행 설정', welcome_title: '일행에 오신 것을 환영합니다', welcome_where: '일행은 화면 오른쪽 위 메뉴 막대에 있습니다', welcome_left_t: '왼쪽 클릭', welcome_left_d: '창 열기 또는 숨기기', welcome_right_t: '오른쪽 클릭', welcome_right_d: '기념일 · 화면 분할 · 일반 설정 · 정보', welcome_two_t: '메뉴 막대에 아이콘 두 개 추가', welcome_two_d: '할 일 목록과 달력', welcome_start: '시작하기' },
    es: { settings_title: 'Ajustes de RiXing', welcome_title: 'Te damos la bienvenida a RiXing', welcome_where: 'RiXing vive en la barra de menús, arriba a la derecha', welcome_left_t: 'Clic izquierdo', welcome_left_d: 'Abrir u ocultar la ventana', welcome_right_t: 'Clic derecho', welcome_right_d: 'Aniversarios · Dividir pantalla · General · Acerca de', welcome_two_t: 'Dos iconos nuevos en la barra de menús', welcome_two_d: 'Lista de tareas y Calendario', welcome_start: 'Empezar' },
    fr: { settings_title: 'Réglages de RiXing', welcome_title: 'Bienvenue dans RiXing', welcome_where: 'RiXing vit dans la barre des menus, en haut à droite', welcome_left_t: 'Clic gauche', welcome_left_d: 'Ouvrir ou masquer la fenêtre', welcome_right_t: 'Clic droit', welcome_right_d: 'Anniversaires · Partage d’écran · Général · À propos', welcome_two_t: 'Deux nouvelles icônes dans la barre des menus', welcome_two_d: 'Liste de tâches et Calendrier', welcome_start: 'Commencer' },
    de: { settings_title: 'RiXing-Einstellungen', welcome_title: 'Willkommen bei RiXing', welcome_where: 'RiXing lebt in der Menüleiste, oben rechts', welcome_left_t: 'Linksklick', welcome_left_d: 'Fenster öffnen oder ausblenden', welcome_right_t: 'Rechtsklick', welcome_right_d: 'Jahrestage · Bildschirm teilen · Allgemein · Über', welcome_two_t: 'Zwei neue Symbole in der Menüleiste', welcome_two_d: 'Aufgabenliste und Kalender', welcome_start: 'Loslegen' },
    ru: { settings_title: 'Настройки 日行', welcome_title: 'Добро пожаловать в 日行', welcome_where: '日行 живёт в строке меню, справа вверху экрана', welcome_left_t: 'Левый клик', welcome_left_d: 'Открыть или скрыть окно', welcome_right_t: 'Правый клик', welcome_right_d: 'Годовщины · Разделение экрана · Общие · О программе', welcome_two_t: 'Два новых значка в строке меню', welcome_two_d: 'Список задач и Календарь', welcome_start: 'Начать' },
  };
  for (const k in DICT) Object.assign(DICT[k], WELCOME[k] || {});

  // 「简明教程」：通用页顶部的轻量提示标题
  const GUIDE = {
    'zh-CN': { guide: '简明教程' }, en: { guide: 'Quick guide' }, ja: { guide: 'かんたんガイド' },
    ko: { guide: '간단 가이드' }, es: { guide: 'Guía rápida' }, fr: { guide: 'Guide rapide' },
    de: { guide: 'Kurzanleitung' }, ru: { guide: 'Кратко' },
  };
